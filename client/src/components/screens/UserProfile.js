    ...
    return (
        <>
            ...
            <div style={{
                ...
                <div>
                    <img alt="ava" style={{ width:"120px",objectFit:"cover", height:"120px", borderRadius:"50%",margin:"0 0 30px 0" }}
                ...
                <div>   
                    ...
                    <div style={{ display: "flex", opacity:"0.7", justifyContent:"space-between"}}>
                        <h5 style={{margin:"0 5px",fontSize:"20px"}}>{userProfile.posts.length} posts</h5>
                        <h5 style={{margin:"0 5px",fontSize:"20px"}}>{userProfile.user.followers.length} followers</h5>
                        <h5 style={{margin:"0 5px",fontSize:"20px"}}>{userProfile.user.following.length} following</h5>
                    </div>
                    <div>
